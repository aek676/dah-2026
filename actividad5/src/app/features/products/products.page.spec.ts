...
describe('ProductsPage', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ProductsPage, IonHeader, IonToolbar, IonTitle, IonContent, IonButtons, IonBackButton, IonList, IonItem, IonLabel, IonButton],
  ...
  it('should display correct product names', () => {
    ...
    expect(names).toEqual(['Shampoo', 'Conditioner', 'Hair Oil', 'Face Mask', 'Body Lotion']);
  });
});